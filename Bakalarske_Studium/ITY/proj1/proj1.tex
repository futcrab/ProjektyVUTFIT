...
\begin{document}
    ...
    \label{two}
        Smíšená sazba má o~něco volnější pravidla. Klasická hladká sazba se doplňuje o~další řezy písma pro zvýraznění důle\-žitých pojmů. Existuje \myuv{pravidlo}:
            \begin{quotation}{
                Čím více \emph{druhů}, \textbf{řezů}, \huge velikostí\normalsize,  \textcolor{blue}{barev} písma a jiných \textsc{\textcolor{red}{efektů}} \underline{použijeme}, tím \textcolor{Orange}{pro\-fe\-sio\-nál\-ně\-ji} bude {\fontfamily{pzc}\selectfont \Large dokument} vypadat. \tiny Čtenář \normalsize tím bude vždy \Huge\textbf{nadšen!}
            }\end{quotation}
