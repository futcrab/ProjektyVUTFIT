...
int main(int argc, char **argv)
{
  ...
  */
  MemDesc md(&particles.positions[0].x,                 3,                          0, // PosX
             &particles.positions[0].y,                 3,                          0, // PosY
             &particles.positions[0].z,                 3,                          0, // PosZ
             &particles.velocities[0].x,                3,                          0, // VelX
             &particles.velocities[0].y,                3,                          0, // VelY
             &particles.velocities[0].z,                3,                          0, // VelZ
             particles.weights,                         1,                          0, // Weight
             N,
             recordsCount);
