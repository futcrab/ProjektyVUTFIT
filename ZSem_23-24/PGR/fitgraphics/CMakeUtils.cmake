...
function(missingTargets targets result)
  foreach(target ${targets})
    if(NOT TARGET ${target})
      list(APPEND listOfMissingTargets ${target})
    endif()
  endforeach()
  set(${result} ${listOfMissingTargets} PARENT_SCOPE)
endfunction()
...
function(addApp2 name srcs targets)
  message("${name}")
  missingTargets("${targets}" emptyTargets)
  if(NOT "${emptyTargets}" STREQUAL "")
    message("app ${name} will not be built, because ${emptyTargets} do not exist")
    return()
  endif()
